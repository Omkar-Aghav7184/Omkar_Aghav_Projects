...
import net.journalApp.dto.JournalEntriesDTO;
import net.journalApp.entity.JournalAppEntry;
...
public class journalControllerV2 {
    ...
    @PostMapping()
    public ResponseEntity<JournalAppEntryV2> createNewEntry(@RequestBody JournalEntriesDTO journalDTO)
    {
        try{
            Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
            String userName = authentication.getName();
